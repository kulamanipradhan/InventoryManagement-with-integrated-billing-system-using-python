...
class employeeClass:
    def __init__(self,root):
        ...
        #options
        cmb_serach =ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state="readonly",justify=CENTER,font=("goudy old styl",15))
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Others"),state="readonly",justify=CENTER,font=("goudy old styl",15))
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state="readonly",justify=CENTER,font=("goudy old styl",15))
        ...
        btn_clear =Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="brown",fg="white",cursor = "hand2").place(x=860,y=305,width=110,height=28)
        #employee details
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This employee id already assigned,try diffrerent",parent=self.root)
                else:
                    ...
                    con.commit()
                    messagebox.showinfo("success","Emplpoyee added Successfully",parent=self.root)
                    self.show()
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("success","Emplpoyee updated Successfully",parent=self.root)
                    self.show()
